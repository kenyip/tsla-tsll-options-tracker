...
| **Direction / regime bias** | Bull / bear / neutral / stand-aside | Shared-window scoreboard plus `regime_router_sim.py`: one no-lookahead PCS/CCS/IC position with standalone controls; first eight-symbol default-DNA router was rejected |
