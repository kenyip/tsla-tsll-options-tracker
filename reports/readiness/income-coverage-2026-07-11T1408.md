...
| `butterfly_spread` | butterfly_sim | neutral_to_bullish_pin | 8 | {'candidate': 8} |
...
| `diagonal_spread` | diagonal_sim | bullish_time_decay | 4 | {'candidate': 4} |
