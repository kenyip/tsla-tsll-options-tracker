...
| `cash_secured_put` | single_leg | prefer_put | 4 | {'candidate': 4} |
...
| `regime_short_premium` | single_leg | regime_directed | 3 | {'testing': 1, 'candidate': 2} |
| `roll_defend` | single_leg | regime_directed | 2 | {'testing': 1, 'candidate': 1} |
| `short_call_credit` | single_leg | prefer_call | 1 | {'candidate': 1} |
...
| `wheel_assignment` | single_leg | prefer_put | 15 | {'candidate': 13, 'testing': 2} |
