# Income strategy coverage — 2026-07-11T1704

Source: `scripts/trader_income_coverage.py` · doctrine: `docs/INCOME_STRATEGY_COVERAGE.md`

- Catalog structures: **17**
- Hypotheses: **195** ({'paper': 1, 'testing': 14, 'candidate': 180})
- Evolve sim artifacts: **53** under `.cache/platform/evolve_backtests/`
...
| `calendar_spread` | calendar_sim | time_decay_neutral_to_bullish | 14 | {'candidate': 14} |
...
| `short_dte_aggressive` | single_leg | regime_directed | 12 | {'testing': 2, 'candidate': 10} |
...
- cost realism — fixed-dollar per-leg half-spread axis built across PCS/CCS/IC/iron-butterfly/calendar/diagonal/butterfly/debit-vertical proxies; replace assumptions with observed quotes
