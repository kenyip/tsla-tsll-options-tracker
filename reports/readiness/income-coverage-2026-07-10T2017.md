...
| `cash_secured_put` | single_leg | prefer_put | 11 | {'candidate': 11} |
...
| `regime_short_premium` | single_leg | regime_directed | 9 | {'testing': 1, 'candidate': 8} |
