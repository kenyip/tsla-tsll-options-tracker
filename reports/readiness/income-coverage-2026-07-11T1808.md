# Income strategy coverage — 2026-07-11T1808

Source: `scripts/trader_income_coverage.py` · doctrine: `docs/INCOME_STRATEGY_COVERAGE.md`

- Catalog structures: **17**
- Hypotheses: **206** ({'paper': 1, 'testing': 14, 'candidate': 191})
- Evolve sim artifacts: **55** under `.cache/platform/evolve_backtests/`
...
| `iron_butterfly` | iron_butterfly_sim | neutral_pin_credit | 5 | {'candidate': 5} |
...
- cost realism — exact PCS/CCS/IC strategy-leg/expiry/strike/as-of-time join + reject gate built on normalized observed archives; one current snapshot yields zero historical entry/exit matches, so forward archive density and observed-cost calibration remain missing
