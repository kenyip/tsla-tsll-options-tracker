# Income strategy coverage — 2026-07-11T2129

Source: `scripts/trader_income_coverage.py` · doctrine: `docs/INCOME_STRATEGY_COVERAGE.md`

- Catalog structures: **18**
- Hypotheses: **226** ({'paper': 1, 'testing': 14, 'candidate': 211})
...
- butterfly family — long call plus symmetric and broken-wing credit iron-butterfly BS scaffolds + B3/B4 dispatch built; all tested proxy families cost-fragile, with pin/assignment and observed option surfaces missing
