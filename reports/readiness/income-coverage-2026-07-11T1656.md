# Income strategy coverage — 2026-07-11T1656

Source: `scripts/trader_income_coverage.py` · doctrine: `docs/INCOME_STRATEGY_COVERAGE.md`

- Catalog structures: **17**
- Hypotheses: **189** ({'paper': 1, 'testing': 14, 'candidate': 174})
- Evolve sim artifacts: **52** under `.cache/platform/evolve_backtests/`
...
| `butterfly_spread` | butterfly_sim | neutral_to_bullish_pin | 10 | {'candidate': 10} |
| `calendar_spread` | calendar_sim | time_decay_neutral_to_bullish | 12 | {'candidate': 12} |
| `call_credit_spread` | pcs_sim | prefer_call | 4 | {'candidate': 4} |
| `cash_secured_put` | single_leg | prefer_put | 14 | {'candidate': 14} |
| `diagonal_spread` | diagonal_sim | bullish_time_decay | 6 | {'candidate': 6} |
...
| `short_put_credit` | single_leg | prefer_put | 14 | {'candidate': 13, 'testing': 1} |
...
- cost realism — fixed-dollar per-leg half-spread axis built for PCS/CCS/IC/iron-butterfly; extend uniformly to calendar/diagonal/butterfly/debit-vertical proxies and replace assumptions with observed quotes
