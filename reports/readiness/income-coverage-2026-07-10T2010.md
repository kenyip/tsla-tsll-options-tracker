...
| `regime_short_premium` | single_leg | regime_directed | 7 | {'testing': 1, 'candidate': 6} |
| `roll_defend` | single_leg | regime_directed | 7 | {'testing': 1, 'candidate': 6} |
| `short_call_credit` | single_leg | prefer_call | 4 | {'candidate': 4} |
...
| `wheel_assignment` | single_leg | prefer_put | 20 | {'candidate': 18, 'testing': 2} |
