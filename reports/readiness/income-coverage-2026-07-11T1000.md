# Income strategy coverage — 2026-07-11T1000

Source: `scripts/trader_income_coverage.py` · doctrine: `docs/INCOME_STRATEGY_COVERAGE.md`

- Catalog structures: **16**
- Hypotheses: **159** ({'paper': 1, 'testing': 14, 'candidate': 144})
- Evolve sim artifacts: **41** under `.cache/platform/evolve_backtests/`
...
|---|---|---|---:|---|
| `bear_put_debit_spread` | debit_vertical_sim | bearish_not_bullish | 2 | {'candidate': 2} |
| `bull_call_debit_spread` | debit_vertical_sim | bullish_not_bearish | 6 | {'candidate': 6} |
| `butterfly_spread` | butterfly_sim | neutral_to_bullish_pin | 6 | {'candidate': 6} |
