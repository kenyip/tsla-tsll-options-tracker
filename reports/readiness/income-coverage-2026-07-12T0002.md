# Income strategy coverage — 2026-07-12T0002
...
- direction-bias lab — shared-window scoreboard + no-lookahead shared-position PCS/CCS/IC router with standalone controls built; first eight-symbol default-DNA run was cost-vacuous/DD-rejected, so expand acceptance diagnostics before any retune and retain observed-data realism boundary
