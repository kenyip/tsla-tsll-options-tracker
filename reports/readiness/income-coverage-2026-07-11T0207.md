# Income strategy coverage — 2026-07-11T0207

Source: `scripts/trader_income_coverage.py` · doctrine: `docs/INCOME_STRATEGY_COVERAGE.md`

- Catalog structures: **14**
- Hypotheses: **151** ({'paper': 1, 'testing': 14, 'candidate': 136})
- Evolve sim artifacts: **33** under `.cache/platform/evolve_backtests/`
