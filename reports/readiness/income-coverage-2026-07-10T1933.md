...
| `put_credit_spread` | pcs_sim | prefer_put | 5 | {'testing': 3, 'candidate': 2} |
...
| `short_put_credit` | single_leg | prefer_put | 8 | {'candidate': 7, 'testing': 1} |
