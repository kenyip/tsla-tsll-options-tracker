...
| `cash_secured_put` | single_leg | prefer_put | 5 | {'candidate': 5} |
...
| `regime_short_premium` | single_leg | regime_directed | 4 | {'testing': 1, 'candidate': 3} |
| `roll_defend` | single_leg | regime_directed | 5 | {'testing': 1, 'candidate': 4} |
| `short_call_credit` | single_leg | prefer_call | 2 | {'candidate': 2} |
| `short_dte_aggressive` | single_leg | regime_directed | 5 | {'testing': 2, 'candidate': 3} |
| `short_put_credit` | single_leg | prefer_put | 11 | {'candidate': 10, 'testing': 1} |
| `wheel_assignment` | single_leg | prefer_put | 16 | {'candidate': 14, 'testing': 2} |
