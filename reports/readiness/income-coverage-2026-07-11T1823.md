...
| `butterfly_spread` | butterfly_sim | neutral_to_bullish_pin | 13 | {'candidate': 13} |
...
| `iron_butterfly` | iron_butterfly_sim | neutral_pin_credit | 6 | {'candidate': 6} |
...
- cost realism — exact PCS/CCS/IC strategy-leg/expiry/strike/as-of-time join + reject gate and Friday weekly-expiry abstraction built; one current snapshot yields zero historical entry/exit matches, so forward archive density, actual available-expiry/strike grids, and observed-cost calibration remain missing
