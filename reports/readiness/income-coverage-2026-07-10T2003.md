...
| `roll_defend` | single_leg | regime_directed | 3 | {'testing': 1, 'candidate': 2} |
| `short_call_credit` | single_leg | prefer_call | 2 | {'candidate': 2} |
| `short_dte_aggressive` | single_leg | regime_directed | 4 | {'testing': 2, 'candidate': 2} |
