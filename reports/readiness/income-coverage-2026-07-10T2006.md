...
| `put_credit_spread` | pcs_sim | prefer_put | 7 | {'testing': 3, 'candidate': 4} |
| `regime_short_premium` | single_leg | regime_directed | 5 | {'testing': 1, 'candidate': 4} |
...
| `wheel_assignment` | single_leg | prefer_put | 17 | {'candidate': 15, 'testing': 2} |
