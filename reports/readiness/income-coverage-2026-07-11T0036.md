# Income strategy coverage — 2026-07-11T0036

Source: `scripts/trader_income_coverage.py` · doctrine: `docs/INCOME_STRATEGY_COVERAGE.md`

- Catalog structures: **13**
- Hypotheses: **138** ({'paper': 1, 'testing': 14, 'candidate': 123})
- Evolve sim artifacts: **24** under `.cache/platform/evolve_backtests/`
...
| `wheel_assignment` | single_leg | prefer_put | 26 | {'candidate': 24, 'testing': 2} |
