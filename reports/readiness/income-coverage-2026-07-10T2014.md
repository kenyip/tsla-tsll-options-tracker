...
| `cash_secured_put` | single_leg | prefer_put | 9 | {'candidate': 9} |
| `iron_condor` | pcs_sim | range_bound | 5 | {'candidate': 5} |
| `long_dte_conservative` | single_leg | regime_directed | 3 | {'candidate': 3} |
| `put_credit_spread` | pcs_sim | prefer_put | 10 | {'testing': 3, 'candidate': 7} |
...
| `short_call_credit` | single_leg | prefer_call | 6 | {'candidate': 6} |
...
| `wheel_assignment` | single_leg | prefer_put | 23 | {'candidate': 21, 'testing': 2} |
