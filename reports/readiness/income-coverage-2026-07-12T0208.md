# Income strategy coverage — 2026-07-12T0208

Source: `scripts/trader_income_coverage.py` · doctrine: `docs/INCOME_STRATEGY_COVERAGE.md`

- Catalog structures: **20**
- Hypotheses: **239** ({'paper': 1, 'testing': 14, 'candidate': 224})
- Evolve sim artifacts: **66** under `.cache/platform/evolve_backtests/`
...
| `put_credit_spread` | pcs_sim | prefer_put | 19 | {'testing': 3, 'candidate': 16} |
