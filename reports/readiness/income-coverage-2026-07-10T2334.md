# Income strategy coverage — 2026-07-10T2334

Source: `scripts/trader_income_coverage.py` · doctrine: `docs/INCOME_STRATEGY_COVERAGE.md`

- Catalog structures: **13**
- Hypotheses: **134** ({'paper': 1, 'testing': 14, 'candidate': 119})
- Evolve sim artifacts: **22** under `.cache/platform/evolve_backtests/`
...
|---|---|---|---:|---|
| `calendar_spread` | calendar_sim | time_decay_neutral_to_bullish | 6 | {'candidate': 6} |
| `call_credit_spread` | pcs_sim | prefer_call | 4 | {'candidate': 4} |
| `cash_secured_put` | single_leg | prefer_put | 14 | {'candidate': 14} |
| `diagonal_spread` | diagonal_sim | bullish_time_decay | 1 | {'candidate': 1} |
...
- diagonal_spread — BS defined-debit scaffold + B3/B4 dispatch built; observed option surfaces, assignment realism, and exact-DNA OOS missing
