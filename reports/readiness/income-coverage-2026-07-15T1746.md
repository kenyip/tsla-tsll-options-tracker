# Income strategy coverage — 2026-07-15T1746
...
- cost realism — exact PCS/CCS/IC leg/time join + reject gate, Friday abstraction, archive-backed date-aware expiry/strike-grid provider, and all-expiration atomic append capture built; the current TSLL archive covers 3/3 dates; newest-date expiration breadth is 13; the three-date floor is plumbing only, so it cannot establish historical edge or L1; complete observed entry/exit joins and materially deeper history remain required
